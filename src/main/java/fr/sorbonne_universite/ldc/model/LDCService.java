...
public interface LDCService extends SciJavaService {
	...
	// Include holes
	public boolean analyseIncludeHolesEnabled();
	public void setAnalyseIncludeHoles(boolean analyseIncludeHoles);
     ...
     * it returns the preview as an image showing outlines of detected particles.
     * @param img	The current image to consider.
     * @see	MeasuresPreviewWorker
     */
    public SwingWorker<ImagePlus,Void> createMeasuresPreviewWorker(ImagePlus img);
